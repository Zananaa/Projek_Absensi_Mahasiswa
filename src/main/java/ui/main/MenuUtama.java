...
public class MenuUtama extends JFrame {
    ...
    private void initComponents() {
        ...
        String projectPath = System.getProperty("user.dir"); // Lokasi root proyek

        jPanelGradient1 = new ui.customJar.JPanelGradient();
        jPanelGradient2 = new ui.customJar.JPanelGradient();
        btnProfil = new ui.customJar.buttonRoundC1();
        ...
        jPanelGradient2.setColorEnd(new Color(51, 197, 215));
        jPanelGradient2.setColorStart(new Color(7, 40, 133));
        ...
        lbl_logo.setIcon(new javax.swing.ImageIcon(projectPath + "/src/main/java/ui/img/logo uniska_11zon.png")); // NOI18N
        ...
        pn_sidebar.setBackground(new Color(198, 215, 231));

        pn_menu.setBackground(new Color(198, 215, 231));
        ...
        lb_MenuHome.setBackground(new Color(198, 215, 231));
        ...
        lb_MenuMhs1.setBackground(new Color(198, 215, 231));
        ...
        lb_MenuAbsen.setBackground(new Color(198, 215, 231));
        ...
        lb_MenuKelas.setBackground(new Color(198, 215, 231));
        ...
        lb_MenuNilai.setBackground(new Color(198, 215, 231));
    ...
    private ui.customJar.buttonRoundC1 btnProfil;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JLabel jLabel3;
    private javax.swing.JLabel jLabel4;
    private javax.swing.JLabel jLabel8;
    private ui.customJar.JPanelGradient jPanelGradient1;
    private ui.customJar.JPanelGradient jPanelGradient2;
