...
public class buttonRoundC31 extends JButton{
    ...
    public buttonRoundC31() {
        fillOriginal = new Color(61, 199, 30);
        fillOver = new Color(56, 156, 34);
        fillClick = new Color(61, 199, 30);
        strokWidth = 2;
        roundedCorner = 10;
        fill = fillOriginal;
        icon = null;
