...
public class buttonRoundC2 extends JButton{
    ...
    public buttonRoundC2() {
        fillOriginal = new Color(255, 28, 28);
        fillOver = new Color(194, 25, 25);
        fillClick = new Color(255, 28, 28);
        strokWidth = 2;
        roundedCorner = 10;
        fill = fillOriginal;
        icon = null;
